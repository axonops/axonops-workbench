...
Althoough you can download a specific release from project [releases](https://github.com/axonops/axonops-workbench/releases), for the best experience we recommend downloading stable releases of AxonOps Workbench directly from our website:
