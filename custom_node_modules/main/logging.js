...
const getLogsDirectory = async () => {
  if (ipcRenderer !== undefined) {
    return await ipcRenderer.invoke('get-logs-directory');
  } else if (typeof global.LogsDirectory !== 'undefined') {
    LogsDirectory = global.LogsDirectory
  } else {
    const App = require('electron').app
    LogsDirectory = App.getPath('logs')
  }
  
  return await LogsDirectory
}
...
class Logging {
  ...
  constructor(data) {
    return (async () => {
      ...
      this.loggingFilesPath = await getLogsDirectory()
