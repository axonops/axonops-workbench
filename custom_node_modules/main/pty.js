...
class Pty {
    ...
    main.process.on('data', (data) => {
      try {
        ...
        try {
          ...
          latestCommand = manipulateOutput(leanCommand(latestCommand))
        } catch (e) {
   ...
   * The function takes two arguments; the command's text, and the associated block's ID if there's any
   */
   ...
   */
  checkConnectivity(checkConnectivityRequestID) {
    ...
    this.command(`check connection (${checkConnectivityRequestID})`)
