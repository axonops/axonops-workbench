...
let getMemoryUsage = () => {
  ...
  try {
    ...
    try {
      ...
      log.error('Crash reporter failed to get memory usage', e)
    } catch (e) {}
  }
...
let getMemory = async () => {
  ...
  try {
    ...
    try {
      ...
      log.error('Crash reporter failed to get information about memory', e)
    } catch (e) {}
  }
...
let getCPU = async () => {
  ...
  try {
    ...
    try {
      ...
      log.error('Crash reporter failed to get CPU info', e)
    } catch (e) {}
  }
...
let getMachineInfo = async () => {
  ...
  try {
    ...
    try {
      ...
      log.error('Crash reporter failed to get machine info', e)
    } catch (e) {}
  }
