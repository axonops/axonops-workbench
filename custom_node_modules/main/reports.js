...
let getMemoryUsage = () => {
  ...
  try {
    ...
    if (isNaN(parseInt(e.toString())))
      log.warning('Crash reporter failed to get memory usage', {'error': e})
  }
...
let getMemory = async () => {
  ...
  try {
    ...
    try {
      ...
      log.warning('Crash reporter failed to get information about memory', {'error': e})
    } catch (e) {}
  }
...
let getCPU = async () => {
  ...
  try {
    ...
    try {
      ...
      log.warning('Crash reporter failed to get CPU info', {'error': e})
    } catch (e) {}
  }
...
let getMachineInfo = async () => {
  ...
  try {
    ...
    try {
      ...
      log.warning('Crash reporter failed to get machine info', {'error': e})
    } catch (e) {}
  }
