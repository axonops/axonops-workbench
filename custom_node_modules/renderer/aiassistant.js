...
let getQuestions = (callback) => {
  ...
  addLog(`Retrieve saved answered questions from the AI Assistant`, 'process')
...
let saveQuestion = (question, questionID, questionDate, answer, answerDate, callback) => {
  // Add log about this process
  addLog(`Save an answered question '${question.slice(20)}...'`, 'process')
...
let deleteQuestion = (questionID, callback) => {
  // Add log about this process
  addLog(`Delete an answered question '${questionID}'`, 'process')
