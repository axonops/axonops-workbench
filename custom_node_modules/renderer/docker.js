...
class DockerCompose {
  ...
  async createDockerComposeYAML(cassandraVersion = '4.0', numOfNodes = 3) {
    ...
    [this.axonopsPort, this.cassandraPort01, this.cassandraPort02, this.cassandraPort03] = await getRandomPort(4)
    ...
    yamlContent = yamlContent.replace(/\{cassandraPort01\}/gm, `${this.cassandraPort01}`)
    yamlContent = yamlContent.replace(/\{cassandraPort02\}/gm, `${this.cassandraPort02}`)
    yamlContent = yamlContent.replace(/\{cassandraPort03\}/gm, `${this.cassandraPort03}`)
    ...
    return {
      ports: {
        ...
        cassandra: this.cassandraPort01
      },
