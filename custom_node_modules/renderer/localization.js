...
let loadLocalization = (callback) => {
  ...
  log.info('Loading recognized languages as a part of the localization process...')
  ...
  try {
    ...
    for (let language of languages) {
      ...
      try {
        log.debug('Loading localisation...', {'localisation': language})
        ...
        log.warning('Something went wrong while loading localisation', {'localisation': language, 'error': e})
      }
    }
  } catch (e) {
    log.warning('Loading localisations failed', {'path': localizationPath, 'error': e})
  } finally {
...
let applyLanguage = (langKey) => {
  // Add log about this process
  log.info('Applying language over the UI, sub-elements and dynamic elements...', {'language': langKey.toUpperCase()})
  ...
  try {
    ...
    log.warning('Something went wrong applying language',  {'language': langKey.toUpperCase(), 'error': e})
  }
}
