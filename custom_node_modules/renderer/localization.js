 ...
 * @Usage:
 * To use it in the UI, a span element could be add with specific attributes:
...
let applyLanguage = (langKey) => {
   ...
   * If the pssed key is not defined or the language is corrupted nothing will happen
   */
