...
let saveWorkspace = async (workspace) => {
  ...
  try {
    ...
    try {
      ...
      let clustersManifest = await FS.readFileSync(Path.join(workspacePath, 'clusters.json'), 'utf8')
      ...
      await FS.writeFileSync(Path.join(workspacePath, 'clusters.json'), applyJSONBeautify(clustersManifest))
