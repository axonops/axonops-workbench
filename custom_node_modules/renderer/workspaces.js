  ...
  try {
    ...
    for (let workspace of workspaces) {
      try {
        ...
        log.error('Failed to get clusters for workspace', {'workspace': workspace.name,'error': e})
      }
    }
  } catch (e) {
...
let deleteWorkspace = async (workspace, workspaces, keepFiles = false) => {
  ...
  try {
    ...
    log.error('Something went wrong removing workspace', {'workspace': workspace.name, 'keepFiles': keepFiles, 'error': e})
  } finally {
