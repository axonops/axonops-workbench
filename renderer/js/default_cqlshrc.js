...
// The content of the default `cqlsh.rc` file, which is used as template when creating a new cluster
const CQLSHRC = `; Licensed to the Apache Software Foundation (ASF) under one
...
;; both module and class will be used to dynamically load the class
;; all other properties found here and in the credentials file under the class name
;; will be passed to the constructor
; module = cassandra.auth
; classname = PlainTextAuthProvider
;; DON'T ADD USERNAME, PASSWORD, OR ANY SENSITIVE DATA HERE
