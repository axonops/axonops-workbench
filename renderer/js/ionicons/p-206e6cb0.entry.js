...
const c = o => {
  ...
  h = class {
    constructor(i) {
      o(this, i), this.isVisible = !1, this.mode = d(), this.lazy = !1, this.sanitize = !0
    }
    connectedCallback() {
    ...
    loadIcon() {
      if (this.isVisible) {
        const o = s(this);
        o && (a.has(o) ? this.svgContent = a.get(o) : ((o, i) => {
          let t = l.get(o);
          if (!t) {
            if ("undefined" == typeof fetch || "undefined" == typeof document) return a.set(o, ""), Promise.resolve();
            t = fetch(o).then(t => {
              if (t.ok) return t.text().then(t => {
                t && !1 !== i && (t = (o => {
                  const i = document.createElement("div");
                  i.innerHTML = o;
                  for (let n = i.childNodes.length - 1; n >= 0; n--) "svg" !== i.childNodes[n].nodeName.toLowerCase() && i.removeChild(i.childNodes[n]);
                  const t = i.firstElementChild;
                  if (t && "svg" === t.nodeName.toLowerCase()) {
                    const o = t.getAttribute("class") || "";
                    if (t.setAttribute("class", (o + " s-ion-icon").trim()), c(t)) return i.innerHTML
                  }
                  return ""
                })(t)), a.set(o, t || "")
              });
